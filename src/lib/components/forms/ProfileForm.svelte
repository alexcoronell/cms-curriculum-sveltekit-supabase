...
<div class="ProfileForm">
    <form class="ProfileForm__form">
        ...
        <div class="ProfileForm__imageInput">
            <input type="file" readonly={isReadOnly}>
        </div>
...
<style>
    .ProfileForm {
        @apply w-full mx-auto max-w-[400px];
    }
    ...
    .ProfileForm__image {
        @apply w-full max-w-[200px] overflow-hidden rounded-full border border-primary flex items-center justify-center mx-auto;
    }
